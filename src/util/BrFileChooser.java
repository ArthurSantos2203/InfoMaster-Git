...
public class BrFileChooser {
    ...
    public File getArquivo(Component pDialogo, String pOptions, String pFiltro) {
        this.fileChooser = new JFileChooser("C:\\InfoMaster\\imgProdutos");  //Cria uma instância do JFileChooser
    ...
    public String copiarImagem(String pCaminho) {
       String caminhoCompleto="";
        try {
            ...
            caminhoCompleto = "C:\\InfoMaster\\imgProdutos\\produto"+ dt.format(dataDoDia) + ".jpg";
