...
import controller.ControllerTransportadoraCidEst;
...
public class ViewTransportadora extends javax.swing.JFrame {
    ...
    ControllerTransportadoraCidEst controllerTransportadoraCidEst = new ControllerTransportadoraCidEst();
    ArrayList<ModelCidade> listaModelCidades = new ArrayList<>();
    ArrayList<ModelEstado> listaModelEstados = new ArrayList<>();
    ArrayList<ModelTransportadora> listModelTransportadoras = new ArrayList<>();
    ArrayList<ModelTransportadoraCidEst> listaModelTransportadoraCidadeEstados = new ArrayList<>();
...
//filtrar dados na tabela
    ...
    private void carregarTransportadora() {
        listaModelTransportadoraCidadeEstados = controllerTransportadoraCidEst.getListaTransportadoraCidadeEstadoController();
        DefaultTableModel modelo = (DefaultTableModel) tbTransportadora.getModel();
        modelo.setNumRows(0);
        //CARREGA OS DADOS DA LISTA NA TABELA
        int cont = listaModelTransportadoraCidadeEstados.size();
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                listaModelTransportadoraCidadeEstados.get(i).getModelTransportadora().getCodigo(),
                listaModelTransportadoraCidadeEstados.get(i).getModelTransportadora().getNome(),
                listaModelTransportadoraCidadeEstados.get(i).getModelCidade().getNome(),
                listaModelTransportadoraCidadeEstados.get(i).getModelEstado().getUf(),
                listaModelTransportadoraCidadeEstados.get(i).getModelTransportadora().getTelefone()
