...
public class ViewFornecedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfPesquisaFornecedor.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfPesquisaFornecedorFocusLost(evt);
            }
        });

        btPesquisarFornecedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icons 20/icons8-binóculos-filled-50.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icons 20/icons8-excluir-filled-50.png"))); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(tfPesquisaFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 501, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//filtrar dados na tabela
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            if (controllerFornecedor.excluirFornecedorController(codigo)) {
                ...
                JOptionPane.showMessageDialog(this, "Você não pode excluir um fornecedor já vinculada a uma produto ou conta a pagar! \n"
                        + "Para excluir o fornecedor, delete primeiro os registros vinculados a ele.", "ATENÇÃO", JOptionPane.WARNING_MESSAGE);
            }
        }
    ...
    private void tfPesquisaFornecedorFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfPesquisaFornecedorFocusLost
        // converte em maiusculo o que o usuario digitar
        this.tfPesquisaFornecedor.setText(tfPesquisaFornecedor.getText().toUpperCase());
        this.tfPesquisaFornecedor.setText(bLMascaras.TiraAcentos(tfPesquisaFornecedor.getText()));
    }//GEN-LAST:event_tfPesquisaFornecedorFocusLost
    ...
    private boolean alteraFornecedor() {
        ...
        modelFornecedor.setCnpj(this.jtfCNPJ.getText());
        modelFornecedor.setInscEstadual(this.jtfIncEstad.getText());
    ...
    private boolean recuperarFornecedor() {
        ...
        try {
            ...
            this.cbEstado.setSelectedItem(tbFornecedores.getValueAt(linha, 3));
            this.listarCidades();
            ...
            this.jtfNomeFantasia.setText(modelFornecedor.getNomeFantasia());
            this.jtfCNPJ.setText(modelFornecedor.getCnpj());
            this.jtfIncEstad.setText(modelFornecedor.getInscEstadual());
            return true;
        } catch (Exception e) {
